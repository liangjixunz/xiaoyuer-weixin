...
var mybaseUrl = JSON.parse(fs.readFileSync(__dirname+"/../../appConfig.json")).mybaseUrl;
/*
*自定义菜单的获取
 */
...
*成功生成新订单提醒需求方
 */
exports.orderSuccess = function(openid,type,orderID,serviceName,remark,callback){
    var templateId = 'XFVvzrEakYsnruOM6_GSTzlcGEvkNv6CXMj_0qO4X_k';
// URL置空，则在发送后,点击模板消息会进入一个空白页面（ios）, 或无法点击（android）
    var url = mybaseUrl+'/order/info?id=%s&type=%s';
    url =sprintf(url,orderID,type);
...
* 提醒服务方
 */
exports.neworder = function(openid,type,orderID,customInfo,orderType,serviceName,remark,callback){
...
*确认订单通知
 */
exports.ensure  =function(openid,orderId,type,remark,callback){
